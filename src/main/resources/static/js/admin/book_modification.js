...
class BookModificationApi {
    ...
    getBookAndImage() {
        ...
        $.ajax({
            async: false,
            type: "get",
            url: `http://locallhost:8000/api/admin/book/${bookObj.bookCode}`,
            dataType: "json",
            success: response => {
    ...
    removeImg() {
        ...
        $.ajax({
            async: false,
            type: "delete",
            url: `http://locallhost:8000/api/admin/book/${bookObj.bookCode}/image/${imgObj.imageId}`,
            dataType: "json",
            success: response => {
                successFlag = true;
            },
    ...
    registerImg() {
        ...
        $.ajax({
            async: false,
            type: "post",
            url: `http://locallhost:8000/api/admin/book/${bookObj.bookCode}/images`,
...
class BookModificationService {
    ...
    loadBookAndImageData() {
        ...
        if(responseData.bookImage != null){
            ...
            bookImg.src = `http://locallhost:8000/image/book/${responseData.bookImage.saveName}`
        }
